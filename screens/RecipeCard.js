...
export default class RecipeCard extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      is_liked: false,
      likes: this.props.recipe.value.likes
    };
  }
  ...
  render() {
    ...
    if (!this.state.fontsLoaded) {
      ...
      let images = {
        image_1: require("../assets/FastFoodCategory.png"),
        image_2: require("../assets/BreadCategory.png"),
        image_3: require("../assets/FishCategory.png"),
        image_4: require("../assets/ChickenCategory.png"),
        image_5: require("../assets/EggCategory.png"),
        image_6: require("../assets/BeveragesCategory.png"),
        image_7: require("../assets/DessertImage.png")
      };
      return (
        <TouchableOpacity
